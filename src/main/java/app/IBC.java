...
public class IBC implements Handler {

    // URL of this page relative to http://localhost:7000/
    public static final String URL = "/IBC.html";
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<ul class=\"nav navbar-nav\">" + 
                            ...
                            "<li class=\"active\"><a href=\"IBC.html\">Infections By Country</a></li>" + 
        ...
        html = html + "<h1 style=\"text-align: centre; font-family:montserrat; color:000000; font-size: 40px;\"><b>Infections By Country</h1>";
        
        // Sort and Search Button
        html = html +   "<form action=\'/IBC.html\' method=\'post\' class=\"navbar-form navbar-center\" role=\"search\">" +
                            "<div class=\'form-group\'>" +
        ...
        if (Sort_drop == null || Sort_drop.equals("None")) {
            html = html + outputComfirmedCases("None");
        } else {
            html = html + outputComfirmedCases(Sort_drop);
        }
    ...
    public String outputComfirmedCases(String type) {
        String html = "";
        ...
        ArrayList<Integer> cases = jdbc.getComfirmedCases(type);
    ...
    public String outputTextBoxResults1(String userText) {
        String html = "";
        ...
        ArrayList<Integer> cases = jdbc.getComfirmedCases1(userText);
